    ...
    return (
        <View className="flex-1 bg-background px-8 pt-16">
            ...
            >
                ...
                <TextInput
                    className="h-12 pl-4 rounded-lg mt-3 bg-neutral-900 text-white border-2 border-neutral-800 focus:border-green-600"
                    placeholder="Exercício, beber 2L de água, etc..."
